...
1. 在你的head标签中添加
   ...
   ```javascript
       ...
       <link rel="stylesheet" type="text/css" href="https://120.25.87.171/JP-Comment/assets/css/comments.css">
   ```
...
2. 在合适的地方添加下面代码，一般是body最下面(用来放评论)
   ...
   <script type="text/javascript" src="https://120.25.87.171/JP-Comment/assets/js/comments.js"></script>
   ```
